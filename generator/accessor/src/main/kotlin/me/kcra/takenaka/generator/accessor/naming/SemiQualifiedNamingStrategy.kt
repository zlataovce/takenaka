...
/**
 * A semi-qualified class name strategy.
 *
 * @author Matouš Kučera
 */
internal class SemiQualifiedNamingStrategy : SimpleNamingStrategy() {
    override fun klass(model: ClassAccessor, type: GeneratedClassType): String {
        val name = model.internalName
            .fromInternalName() // sanitize name
            .removePrefix("net.minecraft.")
            .removePrefix("com.mojang.")
